...
public class MessageController {
    ...
    public Response sizeMsg() {
        return new Response().setRes(messageService.sizeMsg());
    }
    ...
    public Response sizeMsgUser() {
        return new Response().setRes(messageService.sizeMsgUser());
    }
    ...
    public Response save(
        ...
        msg.setId(messageService.save(msg.getToUserId(), msg) + "");
        return new Response().setRes(msg);
    }
    ...
    public Response findMsg(
        ...
        return new Response().setRes(messageService.findMsg(msgId));
    }
    ...
    public Response findMsgByMerge(
        ...
        return new Response().setRes(messageService.findMsgByMerge(msgId));
    }
    ...
    public Response findBefore(
        ...
        return new Response().setRes(messageService.findBefore(userId, toId, before, count));
    }
    ...
    public Response findBeforeByMerge(
        ...
        return new Response().setRes(messageService.findBeforeByMerge(userId, toId, before, count));
    }
    ...
    public Response findAfter(
        ...
        return new Response().setRes(messageService.findAfter(userId, after, count));
    }
}
