...
import com.walker.spring.dao.LogModelRepository;
import com.walker.spring.dao.LogSocketModelRepository;
import com.walker.spring.dao.LogTimeRepository;
...
public class LogServiceImpl implements LogService {
    ...
    public LogModel saveLogModel(LogModel logModel) {
        ...
        if (logModel.getIS_OK().equalsIgnoreCase("1")) {
    ...
    public void saveStatis() {
        ...
        try {
            ...
            if (keys != null && keys.size() > 0) {
                ...
                Object pages = Page.batch(list, 200, (obj, tbj) -> logTimeRepository.saveAll(obj).size());
        ...
        try {
            ...
            if (list.size() > 0) {
                Object pages = Page.batch(list, 200, (obj, tbj) -> logModelRepository.saveAll(obj).size());
